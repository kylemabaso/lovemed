                        ...
                        <div class="profile-info-widget">
                            ...
                            <div class="profile-det-info">
                                ...
                                <div class="patient-details">
                                    <h5><b>ID :</b> {{ $user->id_number }}</h5>
                                    <h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> {{ $user->language->name }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="notify-block align-items-center d-flex">
                            <div class="me-3 flex-shrink-0">
                                <img alt="Image placeholder"
                                    src="{{ asset('assets/client/img/doctors/doctor-thumb-02.jpg') }}"
                ...
                <div class="card-body pt-0">
                    <div class="user-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#medical" data-bs-toggle="tab"><span class="med-records">Medical
                                        Records</span></a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <table class="table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>$160</td>
                                                    <td>16 Nov 2023</td>
                                                    <td><span class="badge rounded-pill bg-success-light">Confirm</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$400</td>
                                                    <td>13 Nov 2023</td>
                                                    <td><span class="badge rounded-pill bg-danger-light">Cancelled</span>
                                                    </td>
                                                    <td>
                                                        <div class="table-action">
                                                            <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$350</td>
                                                    <td>12 Nov 2023</td>
                                                    <td><span class="badge rounded-pill bg-warning-light">Pending</span>
                                                    </td>
                                                    <td>
                                                        <div class="table-action">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            ...
                                                            <a href="edit-prescription.html"
                                                                class="btn btn-sm bg-success-light" data-bs-toggle="modal"
