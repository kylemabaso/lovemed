                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="patient-profile.html"
                                                        class="avatar avatar-sm me-2"><img
                                                            class="avatar-img rounded-circle"
                                                            src="assets/client/img/patients/patient1.jpg"
                                                            alt="User Image"></a>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="patient-profile.html"
                                                        class="avatar avatar-sm me-2"><img
                                                            class="avatar-img rounded-circle"
                                                            src="assets/client/img/patients/patient2.jpg"
                                                            alt="User Image"></a>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="patient-profile.html"
                                                        class="avatar avatar-sm me-2"><img
                                                            class="avatar-img rounded-circle"
                                                            src="assets/client/img/patients/patient3.jpg"
                                                            alt="User Image"></a>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="patient-profile.html"
                                                        class="avatar avatar-sm me-2"><img
                                                            class="avatar-img rounded-circle"
                                                            src="assets/client/img/patients/patient4.jpg"
                                                            alt="User Image"></a>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="patient-profile.html"
                                                        class="avatar avatar-sm me-2"><img
                                                            class="avatar-img rounded-circle"
                                                            src="assets/client/img/patients/patient5.jpg"
                                                            alt="User Image"></a>
